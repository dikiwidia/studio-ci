...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>administrator">The Alfa Studio</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul id="g-account-menu" class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url(); ?>administrator/logout"><i class="glyphicon glyphicon-lock"></i> Keluar</a></li>
                    </ul>
                </li>
            </ul>
        </div>
